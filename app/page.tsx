      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">Clarity Learning Labs</span>
          </Link>
      ...
      <section className="pt-28 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 sm:mb-10 text-pretty">
            Experiential learning designed to meet the 2026 Registered Behavior Technician 40 hour-training requirements. Practice with AI simulated clients and track your competencies, through gamified progression.
          </p>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-b from-background to-primary/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 text-sm sm:text-base">
            Join Clarity Learning Labs today and accelerate your path to clinical excellence through
